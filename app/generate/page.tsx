...
//         className="w-full flex items-center justify-between p-4 bg-gray-200 text-black rounded-xl"
//         whileHover={{ backgroundColor: "#f8f8f8" }}
//       >
//         <div className="flex items-center space-x-2">
//           <Settings className="w-5 h-5" />
//           <span className="font-light">Customizations</span>
//         </div>
//         <motion.div
...
//                     <span className="text-sm text-black">Difficulty Level</span>
//                   </div>
//                 </div>
//                 <Select
//                   fullWidth
...
//                     width: "fit-content",
//                   }}
//                   checked={questionTypes.includes("fill-in-the-blanks")}
//                 />
//                 FILL IN THE BLANKS
//                 <Checkbox
//                   style={{
...
// In the main QuizGenerator component, update the state and add CustomizationPanel:
